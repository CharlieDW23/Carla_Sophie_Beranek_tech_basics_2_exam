...
def create_music_page(root):
    ...
    online_button_1.place(x=30, y=120)
    ...
    online_button_2.place(x=250, y=120)
    ...
    online_button_3.place(x=30, y=200)
    ...
    online_button_4.place(x=250, y=200)
    ...
    online_button_5.place(x=30, y=280)
    ...
    online_button_6.place(x=250, y=280)
    ...
    online_button_7.place(x=30, y=360)
    ...
    online_button_8.place(x=250, y=360)
